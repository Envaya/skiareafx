package ch.fhnw.oop2.skiareasfx.skiregion_cc;
...
public class SkiregionControl extends Region {
    ...
    private void setupEventHandler() {
        ...
        INNER.setOnMouseClicked(event -> {
            setSkiregion("Zentralschweiz");
            setSelectedarea("Zentralschweiz");
        });
        ...
        VDVS.setOnMouseClicked(event -> {
            setSkiregion("Waadt und Wallis");
            setSelectedarea("Waadt und Wallis");
        });

        BE.setOnMouseClicked(event -> {
            setSkiregion("Berner Oberland");
            setSelectedarea("Berner Oberland");
        });
